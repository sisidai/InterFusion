...
class VolumeRendererComp(BaseModule):
    @dataclass
    class Config(BaseModule.Config):
        radius: float = 1.0
    ...
    def configure(
        ...
        self.sub_modules = SubModules(geometry, material, background, geometry_, material_, background_)
    ...
    @property
    def geometry_(self) -> BaseImplicitGeometry:
        return self.sub_modules.geometry_

    @property
    def material_(self) -> BaseMaterial:
        return self.sub_modules.material_

    @property
    def background_(self) -> BaseBackground:
        return self.sub_modules.background_

    def set_geometry(self, geometry: BaseImplicitGeometry) -> None:
        self.sub_modules.geometry = geometry
        self.sub_modules.geometry_ = geometry_

    def set_material(self, material: BaseMaterial) -> None:
        self.sub_modules.material = material
        self.sub_modules.material_ = material_

    def set_background(self, background: BaseBackground) -> None:
        self.sub_modules.background = background
        self.sub_modules.background_ = background_
